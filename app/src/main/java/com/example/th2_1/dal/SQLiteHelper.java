...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public List<Item> getAll(){
        ...
        while (rs!=null && rs.moveToNext()){
            ...
            boolean collab = (rs.getInt(5) == 1);
            items.add(new Item(id, title, content, date, status, collab));
        }
        return items;
    }
...
//    }
    ...
    public long insertItem(Item item){
        ...
        values.put("collaborate", item.isCollaborate());
